...
st.set_page_config(page_title="Timeline Creator", layout="wide")
st.title("Full Video Timeline Creator")
...
if not df.empty and (has_dual_cams or has_single_cam):
    ...
    with col_controls:
        ...
        if has_dual_cams:
            ...
            end_val = raw_time_a if st.session_state.active_cam == 'Cam A (Side Camera)' else raw_time_b
        else:
